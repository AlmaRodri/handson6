...
public class BOptimiza extends Agent {
   ...
   String datos = "53,67,98,123,88,109,145,77,94,136,111,102,83,120,146,70,64,137,95,112,130,75,104,99,142,86,69,118,"+
    ...
    public void setup() {
        ...
        System.out.println("Hello! Search optimizacion "+getAID().getName()+" is ready.");
    ...
    protected void takeDown() {
        ...
        System.out.println("Search optimizacion-agent "+getAID().getName()+" terminating.");
    }
    private class RequestPerformer extends Behaviour{
        ...
        private int repliesCnt = 0; // El contador de respuestas de los agentes clasificadores
        ...
        private int step = 0; // El paso actual en el comportamiento
        private String resultAgentName; // Nombre del agente resultado
        ...
        public void action() {
            switch (step) {
                case 0:
                    ...
                    break;
                case 1:
                    // Recibir todas las propuestas/refusas de los agentes clasificadores
